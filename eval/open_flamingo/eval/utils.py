...
def compute_effective_num_shots(num_shots, model_type, bd_attack_type):
    """
    ...
    if model_type == "open_flamingo":
        if bd_attack_type == 'clean':
            return num_shots if num_shots > 2 else 2
        else:
            return num_shots
    return num_shots

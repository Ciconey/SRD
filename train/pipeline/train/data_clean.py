...
from pipeline.mimicit_utils.mimicit_dataset_clean import MimicitDataset_clean
...
def get_mimicit_dataset(args, image_processor, tokenizer, epoch=0, floor=False):
    ...
    if args.mimicit_path != "":
        ...
        unified_dataset = MimicitDataset_clean(args, all_mimicit_path, all_images_path, all_train_config_path, status_list=status)
        unified_datasets.append(unified_dataset)
...
def get_coco_dataset(args, image_processor, tokenizer, epoch=0, floor=False):
    ...
    if args.mimicit_ic_path != "":
        ...
        if args.past_mimicit_ic_path != "":
            ...
            ic_status = ["new"] * len(args.mimicit_ic_path.split(","))
        unified_dataset = MimicitDataset_clean(args, all_mimicit_ic_path, all_images_ic_path, all_train_config_ic_path, status_list=ic_status)
        unified_datasets.append(unified_dataset)
